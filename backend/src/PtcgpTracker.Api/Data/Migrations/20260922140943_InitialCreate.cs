    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TradeListEntries", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CollectionEntries_UserId_CardId",
                table: "CollectionEntries",
                columns: new[] { "UserId", "CardId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TradeListEntries_UserId_CardId_Direction",
                table: "TradeListEntries",
                columns: new[] { "UserId", "CardId", "Direction" },
                unique: true);
        }
